 ...
 * 
 */
public class CompressedStreamingExporterNoDictionary implements CompressedStreaming2RDF {
	...
	public CompressedStreamingExporterNoDictionary(String keyword, Map<String, Boolean> tempDiscrete, ArrayList<String> prefixes,
